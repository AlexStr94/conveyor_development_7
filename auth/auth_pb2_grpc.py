...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                ...
                response_deserializer=auth__pb2.UserTokenResponse.FromString,
        ...
        self.GetUserId = channel.unary_unary(
                '/auth.AuthService/GetUserId',
                request_serializer=auth__pb2.GetUserIdRequest.SerializeToString,
                response_deserializer=auth__pb2.GetUserIdResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=auth__pb2.UserTokenResponse.SerializeToString,
            ),
            ...
            'GetUserId': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUserId,
                    request_deserializer=auth__pb2.GetUserIdRequest.FromString,
                    response_serializer=auth__pb2.GetUserIdResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def CreateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.UserTokenResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetUserId(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/GetUserId',
            auth__pb2.GetUserIdRequest.SerializeToString,
            auth__pb2.GetUserIdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
